...
fprintf('------------------------------------\n');
fprintf('------------------------------------\n');
fprintf('%.4f\r',Result(1,1));
fprintf('%.4f\r',Result(6,1));
fprintf('%.4f\r',Result(11,1));
fprintf('%.4f\r',Result(12,1));
fprintf('%.4f\r',Result(13,1));
fprintf('%.4f\r',Result(14,1));
fprintf('%.4f\r',Result(15,1));
fprintf('%.4f\r',Result(16,1));
